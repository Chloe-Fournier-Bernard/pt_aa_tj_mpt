...
const welcome = {
  ...
  stimulus: "<p>Welcome to the experiment. This study investigates people's assessment of statements. The study will take about 13 minutes to complete.</p>",
  choices: ["Continue"],
};
...
const consent = {
  ...
  stimulus: `
    ...
    <p>Participation in this study will involve completing a computer-based task involving actions about experimental stimuli, followed by a short survey. Specifically, you will be presented with sentences, which you will be requested to physically approach (by zooming in into the sentence) or to physically avoid (by zooming away from the sentence). These approach-avoidance movements will be implemented by using keys on your keyboard. Your involvement will require about 13 minutes. You will receive £2.60 GBP in exchange for your participation. To participate, you need to use a computer.</p>
...
const save_data = {
  type: jsPsychPipe,
  action: "save",
  experiment_id: "YXleTP4MCvFk", // see DataPipe 
  filename: filename,
